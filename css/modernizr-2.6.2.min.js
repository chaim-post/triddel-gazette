...
<head>
	...
	<style type="text/css">
		...
		function redirect() {
				...
				//location = document.search_form.action + '?iframe=1';
			} else {
				document.search_form.submit();
			}
					}
		function start_counter() {
			self.setTimeout('redirect()', 5000);
		}
	</script>
	</head>
<body onload="start_counter()">
	...
	<div id="container">
		...
		<h2>The page <b>http://triddelgazette.altervista.org/js/vendor/modernizr-2.6.2.min.js</b> was not found on this server.</h2>		
	...
	<input type="hidden" name="q" value="triddelgazette.altervista.org"/>
	<input type="hidden" name="cref" value="http://tb.altervista.org/cgi-bin/cse_xml.pl/C/triddelgazette/en" />
